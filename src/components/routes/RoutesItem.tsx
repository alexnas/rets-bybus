...
const RouteItem: React.FC<IRouteItemProps> = ({ route }) => {
  ...
  const { start_time, end_time, startCityId, price, endCityId, distance } =
    route;
    ...
    <StyledRoutesWrapper>
      <GridLeft>
        <GridLeftTopBottom>
          ...
          <span>{startCityId} Cuenca - Terminal Terrestre</span>
        </GridLeftTopBottom>
        <GridLeftMiddle>
          <StyledBusIcon>
            <FaBus />
        ...
        <GridLeftTopBottom>
          ...
          <span>{endCityId} Loja - Terminal Terrestre</span>
        </GridLeftTopBottom>
      </GridLeft>
